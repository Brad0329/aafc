...
class Enrollment(models.Model):
    ...
    cancel_date = models.DateTimeField('취소일', null=True, blank=True)
    bigo_content = models.CharField('비고', max_length=500, blank=True)
    shuttle_yn = models.CharField('셔틀이용', max_length=1, blank=True)
    account_no = models.CharField('계좌번호', max_length=50, blank=True)
